...
class Scenario(SuperScenario):
    ...
    Scenario 22:
                ...
                Case : Reference Tracking & Equallibrim point
    """
    def __init__(self) -> None:
        ...
        neat = Neat(2, 2)
        file_name = f"{Path().absolute()}/scenarios/scenario_22/scenario_22"
    ...
    def fitness_function(genome: Genome, visualize: bool = False, f_fig=None, f_ax=None, *args, **kwargs) -> Union[float, Any, None]:
        ...
        for i in range(SAMPLES):
            ...
            total_error += abs(e1) #+ abs(f_filt_last - f_filt) * 10
            ######################
            ...
            f_filt = (1-a)*f_filt + a * f  # LOW PASS Filter
            # f_filt = f
